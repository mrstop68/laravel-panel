                        ...
                        <div class="col-lg-12">
                            <div class="main-card mb-3 card">
                                <div class="card-body page-title-wrapper">
                                    ...
                                    <h5 class="card-title">BLOG SAYFASI EKLEME VE SIRALAMA İŞLEMLERİ</h5>
                                    <div class="btn-actions-pane-right"><a href="{{route('blog.create')}}"><button  type="button" class="btn-shadow btn btn-focus">BLOG SAYFASI EKLE</button></a></div></div>
                                        ...
                                        <table class="mb-0 table table-hover">
                                            ...
                                            <tbody id="sortable">
                                                ...
                                                <tr id="item-{{$item->id}}" >
                                                    ...
                                                    <td width="5"><a href="{{route('blog.edit',$item->id)}}"><i class="pe-7s-pen"></i></a></td>
