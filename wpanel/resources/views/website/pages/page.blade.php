...
<div class="container my-5">
    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-md-5">
            <img class="img-fluid" src="/images/page/{{$data->file}}" alt="">
            </div>
            <div class="col-md-7">
...
<div class="container">
        <div class="demo-gallery">
            <ul id="lightgallery">
                @foreach ($imagesPage as $item)
                <li
                data-responsive="/images/gallery/{{$item->file}} 375, /images/gallery/{{$item->file}} 480, /images/gallery/{{$item->file}} 800"
                data-src="/images/gallery/{{$item->file}}"
